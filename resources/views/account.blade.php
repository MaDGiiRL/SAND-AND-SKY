            ...
            <div class="row pt-5">
                <div class="col-md-3 account-nav">
                    ...
                    <nav id="account-nav" class="nav flex-column">
                        <a class="nav-link active" href="#" data-target="account-info">Account information</a>
                ...
                <div class="col-md-9">
                    <div class="account-container">
                        <section id="account-info" class="content-section active">
                            <h4 class="fw-bold text-dark pb-4">Account Information</h4>
                            <form>
                                <div class="mb-3">
