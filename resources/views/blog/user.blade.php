<x-layout title="All Articles from {{$user->name}} - Sand & Sky">
    <div class="bg-register min-vh-100">
        <div class="container pb-5">
            <h3 class="fw-bold text-uppercase text-center p-5"><img src="/images/left.png">All Articles from {{$user->name}} <img src="/images/right.png"></h3>
